#!/usr/bin/env python3
"""
Intelligent Content Analyzer and Categorizer
Analyzes content and creates better medical categories
"""
...
class IntelligentContentAnalyzer:
    ...
    def create_intelligent_categories(self):
        """Create intelligent medical categories based on analysis"""
        ...
        space_cards.append({
            ...
            'collections': [
                ...
                },
                {
                    ...
                    'items': [self._create_content_item(item_id) for item_id in surgical_items if not any(term in self.content_analysis[item_id]['title'].lower() for term in ['appendectomy', 'cholecystectomy', 'hernia', 'laparoscopic', 'thoracoscopic'])]
                }
            ]
        })
        ...
        # 6. Additional Medical Specialties
        remaining_items = []
        used_items = set()
    ...
    def generate_intelligent_structure(self):
        """Generate the complete intelligent structure"""
        ...
        for space_card in space_cards:
            for collection in space_card['collections']:
                collection['items'] = self.remove_duplicates(collection['items'])
        ...
        structure = {
            ...
            'analysis_summary': {
                ...
                'duplicates_removed': len(self.transcription_data) - total_content,
                'categories_created': len(space_cards)
            }
        }
        
        print(f"✅ Generated intelligent structure with {total_content} unique items")
        print(f"📊 Removed {len(self.transcription_data) - total_content} duplicates")
...
if __name__ == "__main__":
    ...
    print("🎉 Intelligent content analysis complete!")
